...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AverageRating>
    avgRatingKafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<String, AverageRating> factory =
